...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
	...
	//	  .append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon ui-icon-circle-close"></span></a></li>') // fix by unixman
		  .appendTo(header),
	...
	_setButtonValue: function(value) {
		...
		this.buttonlabel.html(value); // fix to display htmlspecialchars correctly
		//-- end fix
	},
...
//	  button.addClass('ui-state-active'); // fix by unixman
	  this._isOpen = true;
	  this._trigger('open');
	},
	...
	close: function() {
	  ...
	  this.button.trigger('blur').trigger('mouseleave'); // fix by unixman
	  this._isOpen = false;
	  this._trigger('close');
	},
