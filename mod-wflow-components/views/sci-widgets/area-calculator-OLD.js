...
//--
var JX_Area_Calculator = new function() { // START CLASS

// :: static

var JX_Area_Result_TOTAL = 0;

//--
this.Calculate = function(selectObj, resultDiv, totalDIV) {
	//--
	// :: static
	//--
	...
	if(jx_desc) {
		...
		jx_desc = jx_desc.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;');
	...
	if(jx_result > 0) {
		//--
		JX_Area_Result_TOTAL = Math.round(100 * (parseFloat(JX_Area_Result_TOTAL) + jx_result)) / 100;
		//--
		jx_field.innerHTML += '' + jx_desc + jx_area + '<hr color="#778899" width="100%" size="1" align="center" noshade>';
		jx_total.innerHTML = '<div align="right" class="jx_active_div"><h2><font color="#33CC33"><b>TOTAL AREA:</b></font> <font color="#FF3300"><b>' + JX_Area_Result_TOTAL + '</b></font></div>';
		//--
	} else {
		//--
