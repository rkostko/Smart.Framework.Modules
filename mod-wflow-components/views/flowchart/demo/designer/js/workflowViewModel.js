...
function WorkflowViewModel() {
	...
	*/
	...
	self.saveData = function() {
		...
		//-- unixman
		data.name = 'Workflow';
		var key = 'workflow.save';
		var JsonString = JSON.stringify(data);
		var workflow = new ListViewModel(self, key, name);
		//--
	...
	*/
	function getData(data, isJson) {
		...
		if(isJson !== true) {
			...
			//console.log('Parsing data as Json: ' + data);
		...
		jsPlumb.bind("ready", function() {
			...
			for (var i = 0; i < steps.length; i++) {
				...
				$("#"+steps[i].Id).on( "plumbing-is-dragging", function(event, ui) {
					self.isDirty(true);
				});
			}
...
/*
		...
		for (var i = 0; i < storage.length; i++){
			...
			//	var workflow = self.workflows[i];
			//}
			var workflow = storage[i]; // select first :: //localStorage.removeItem(storage[i]);
			//break;
		}
		//console.log(workflow);
		if(workflow) {
...
*/
	...
	var workflow = '{"name":"Workflow","steps":[{"isStart":true,"Id":1,"name":"Step One","contactType":1,"userType":1,"description":"Start here ...","template":null,"top":"40px","left":"92px"},{"isStart":false,"Id":3,"name":"Step Two","contactType":3,"userType":3,"description":"","template":null,"top":"40px","left":"840px"},{"isStart":false,"Id":4,"name":"Step Three","contactType":4,"userType":1,"description":"Another description","template":1,"top":"360px","left":"249px"},{"isStart":false,"Id":5,"name":"Step Four","contactType":5,"userType":2,"description":"This is a description","template":null,"top":"360px","left":"840px"}],"results":[{"Id":2,"sourceId":"3","targetId":"5","sourceEndpoint":"Bottom","targetEndpoint":"Top","label":"New Extra","daysLater":3},{"Id":4,"sourceId":"4","targetId":"5","sourceEndpoint":"Right","targetEndpoint":"Left","label":"Finalize","daysLater":7},{"Id":5,"sourceId":"1","targetId":"3","sourceEndpoint":"Right","targetEndpoint":"Left","label":"Prepare","daysLater":1},{"Id":6,"sourceId":"1","targetId":"4","sourceEndpoint":"Bottom","targetEndpoint":"Top","label":"Test","daysLater":5}]}';
	getData(workflow, true);
