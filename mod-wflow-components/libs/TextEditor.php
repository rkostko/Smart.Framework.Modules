...
/**
 * Class: TextEditor (Workflow Component)
 *
 * @version 	v.170516
 *
 * @access 		private
...
return \SmartMarkersTemplating::render_file_template(
	'modules/mod-wflow-components/libs/templates/text-editor-init.inc.htm',
	array(
...
//--
return \SmartMarkersTemplating::render_file_template(
	'modules/mod-wflow-components/libs/templates/text-editor-draw.inc.htm',
	array(
...
return (string) str_replace(array("\r\n", "\r", "\n", "\t"), array(' ', ' ', ' ', ' '), (string)\SmartMarkersTemplating::render_file_template(
	'modules/mod-wflow-components/libs/templates/text-editor-callback.inc.js',
	array(
