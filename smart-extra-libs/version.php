...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.180131');
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.3.5.7.r.2018.01.31'); // this must be used to validate the required minimum framework version
