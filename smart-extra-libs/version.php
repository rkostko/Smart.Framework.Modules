...
//-- defines the extralibs version (required for info)
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.170920');
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.3.5.7.r.2017.09.20'); // this must be used to validate the required minimum framework version
