...
define('SMART_APP_MODULES_EXTRALIBS_VER', 'm.ext.180613');
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_EXTRALIBS_MIN_FRAMEWORK_VER', 'v.3.7.5.r.2018.06.13'); // this must be used to validate the required minimum framework version
